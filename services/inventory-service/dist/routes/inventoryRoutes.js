...
const inventoryValidators_1 = __importDefault(require("../validators/inventoryValidators"));
const { createSupplierSchema, updateSupplierSchema, createMovementSchema, upsertSuministraSchema, } = inventoryValidators_1.default;
const inventoryController_1 = __importDefault(require("../controllers/inventoryController"));
const { getSuppliers, getSupplierById, createSupplier, updateSupplier, deleteSupplier, getMovements, createMovement, getSuministra, getSuministraById, upsertSuministra, getAlerts, getKardex, getLotesByProduct, getSuministraByProduct, getLowStock, deleteLote, } = inventoryController_1.default;
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/suppliers', (0, validate_1.default)(createSupplierSchema), createSupplier);
/**
 * @swagger
 * /api/inventory/suppliers/{id}:
 *   put:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.put('/suppliers/:id', (0, validate_1.default)(updateSupplierSchema), updateSupplier);
/**
 * @swagger
 * /api/inventory/suppliers/{id}:
 *   delete:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/movements', (0, validate_1.default)(createMovementSchema), createMovement);
/* ── Suministra (HU14) ────────────────────────────────────────────────────── */
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/suministra', (0, validate_1.default)(upsertSuministraSchema), upsertSuministra);
