...
const server = app_1.default.listen(env_1.default.port, () => {
    logger_1.default.info(`inventory-service corriendo en el puerto ${env_1.default.port}`, {
...
function shutdown(signal) {
    logger_1.default.info(`${signal} recibido — cerrando inventory-service...`);
    server.close(() => {
        logger_1.default.info('inventory-service cerrado correctamente');
        process.exit(0);
    });
