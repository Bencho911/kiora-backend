 ...
 */
async function fetchWithRetry(url, options, { baseDelayMs = 100, maxRetries = 3, timeoutMs = 5000, onNonRetryable = undefined } = {}) {
    let lastError;
...
exports.default = { outgoingHeaders, fetchWithRetry, DEFAULT_TIMEOUT_MS, NOTIFY_TIMEOUT_MS };
