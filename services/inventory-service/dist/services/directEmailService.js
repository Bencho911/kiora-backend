...
function initTransporter() {
    if (!process.env.SMTP_USER || !process.env.SMTP_PASS) {
        logger_1.default.warn('SMTP no configurado en inventory-service. Las alertas de Gmail no funcionarán.');
        return;
    }
    ...
    logger_1.default.info('Motor de correo directo inicializado en inventory-service');
}
/**
...
async function getAdminEmails() {
    ...
    try {
        ...
        logger_1.default.warn('No se pudieron obtener correos de administradores', { error: err.message });
        return [];
    }
}
async function sendLowStockEmail(productData, toOverride = null) {
    ...
    try {
        ...
        logger_1.default.info('Email de alerta enviado DIRECTAMENTE desde inventory-service', { to: recipients });
    }
    catch (error) {
        logger_1.default.error('error', { error: error.message });
    }
}
exports.default = { sendLowStockEmail };
