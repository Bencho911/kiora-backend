...
exports.getFullExport = void 0;
const exportRepo = __importStar(require("../repositories/exportRepository"));
...
const getFullExport = async (req, res, next) => {
    try {
        ...
        logger_1.default.info('Exportación completa solicitada', { filters });
...
exports.getFullExport = getFullExport;
