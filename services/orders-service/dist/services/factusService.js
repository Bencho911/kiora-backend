...
exports.mapPaymentMethodCode = mapPaymentMethodCode;
exports.buildFactusItem = buildFactusItem;
...
async function getAccessToken() {
    ...
    logger_1.default.info('Factus: token OAuth2 obtenido', { expiresIn: data.expires_in });
    return _cachedToken;
}
/**
...
async function createInvoice(order, items, customer = null) {
    ...
    logger_1.default.info('Factus: emitiendo factura electrónica', {
        referenceCode,
    ...
    logger_1.default.info('Factus: factura emitida y validada por DIAN', {
...
async function createCreditNote(billNumber, order, items) {
    ...
    logger_1.default.info('Factus: emitiendo nota crédito', {
        referenceCode,
        billNumber,
        orderId: order.id_vent,
    });
    ...
    logger_1.default.info('Factus: nota crédito emitida y validada por DIAN', {
        number: nc.number,
        billNumber,
        orderId: order.id_vent,
    });
