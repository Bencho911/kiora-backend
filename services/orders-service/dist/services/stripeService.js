...
exports.verifyWebhookSignature = exports.createRefund = exports.createCheckoutSession = void 0;
...
const createRefund = async (paymentIntentId) => {
    try {
        ...
        logger_1.default.info('Stripe: Reembolso emitido', {
            refundId: refund.id,
            paymentIntentId,
        ...
        logger_1.default.error('Error emitiendo reembolso Stripe:', {
            paymentIntentId,
            error: error.message,
        });
        throw error;
