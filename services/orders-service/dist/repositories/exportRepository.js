...
exports.findByDay = exports.findByPaymentMethod = exports.findSummary = exports.findFullExport = void 0;
...
const findFullExport = (filters = {}) => {
    ...
    return db_1.default.query(`SELECT 
         ...
         ORDER BY v.fecha_vent DESC, v.id_vent, pv.id`, [desde || null, hasta || null]);
};
exports.findFullExport = findFullExport;
/**
...
const findSummary = (filters = {}) => {
    ...
    return db_1.default.query(`SELECT 
         ...
         LEFT JOIN Producto_Venta pv ON pv.fk_id_vent = v.id_vent
         WHERE ($1::timestamp IS NULL OR v.fecha_vent >= $1)
           AND ($2::timestamp IS NULL OR v.fecha_vent <= $2)`, [desde || null, hasta || null]);
};
...
const findByPaymentMethod = (filters = {}) => {
    ...
    return db_1.default.query(`SELECT 
         ...
         ORDER BY monto_total DESC`, [desde || null, hasta || null]);
};
exports.findByPaymentMethod = findByPaymentMethod;
/**
...
const findByDay = (filters = {}) => {
    ...
    return db_1.default.query(`SELECT 
         ...
         ORDER BY fecha DESC`, [desde || null, hasta || null]);
};
